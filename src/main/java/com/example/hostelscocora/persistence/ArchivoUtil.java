...
/**
 * Esta clase tien método estáticos que permite usarlos sin crear instancias de la clase
 * Lo que se hizo fue crear esta librería para el manejo de los archivos
 * @author Admin
 *
 */
public  class ArchivoUtil {
     ...
     * @param ruta es la ruta o path donde ésta ubicado el archivo
     * @throws IOException .
     */
    ...
    /**
     * ESte método retorna el contenido del archivo ubicado en una ruta, con la lista de cadenas.
     * @param ruta .
     * @return .
     * @throws IOException .
     */
...
//		Empresa empresa = null;
    ...
    /**
     * guardar un archivo en formato txt
     * @param rutaArchivoInformes .
     * @param mensaje .
     */
    public static void SalvarArchivoTXT(String rutaArchivoInformes, String mensaje,Boolean flag) throws IOException {
        FileWriter fw = new FileWriter(rutaArchivoInformes,flag);
        BufferedWriter bfw = new BufferedWriter(fw);
        bfw.write(mensaje);
        bfw.close();
        fw.close();
